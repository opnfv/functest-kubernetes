...
class RallyKubernetes(testcase.TestCase):
    ...
    def run(self, **kwargs):
        ...
        task = yaml.safe_load(template.render(
            ...
            dockerhub_repo=kwargs.get("dockerhub_repo", self.dockerhub_repo),
            grc_repo=kwargs.get("grc_repo", self.grc_repo),
            k8s_grc_repo=kwargs.get("k8s_grc_repo", self.k8s_grc_repo)))
